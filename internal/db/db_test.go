...
func testDB(t *testing.T) *DB {
	...
	_, err = d.pool.Exec(ctx, `TRUNCATE readings, meters, test_windows, capture_heartbeat, reference_samples, hvac_samples, utility_energy, meter_index, meter_source, sdr_devices`)
	if err != nil {
